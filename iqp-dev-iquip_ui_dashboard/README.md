...
1. git clone HTML_repo_link

2. cd iquip_ui_dashboard/

4. git add --all

5. git commit -m "Initial Commit with code"

6. git push origin master

//After that for every commit and push

1. cd path_to_repo/iquip_ui_dashboard/

2. git pull

3. git add --all

4. git commit -m "Initial Commit with code"
